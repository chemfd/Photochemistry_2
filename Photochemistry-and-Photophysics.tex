...
Updated with learning outcomes for each chapter and some new content in chapter 5. 7th September 2020.
...
\begin{equation}
|V(r)|=|V(r)|^\circ e^{-\frac{\beta(r-r__\circ)}{2}}
\label{eq:reorgenergy}
\end{equation}
