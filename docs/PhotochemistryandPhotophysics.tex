...
\begin{longtable}[]{@{}lll@{}}
\toprule
Compound & k\textsubscript{p} / s\textsuperscript{−1} & k\textsubscript{ST} / s\textsuperscript{−1}\tabularnewline
\midrule
\endhead
naphthalene & 0.05 & 0.39\tabularnewline
1-fluoronaphthalene & 0.23 & 0.42\tabularnewline
1-chloronaphthalene & 1.10 & 2.35\tabularnewline
1-bromonaphthalene & 13.5 & 36.5\tabularnewline
1-iodonaphthalene & 190 & 310\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
& Normalised Fluorescence & \(\tau\) / ns & \(\tau / \tau_0\)\tabularnewline
\midrule
\endfirsthead
\toprule
& Normalised Fluorescence & \(\tau\) / ns & \(\tau / \tau_0\)\tabularnewline
\midrule
\endhead
no modified bases & 1 & 2.80 & 1\tabularnewline
1 8-oxo-G & 0.558 & 2.38 & 0.85\tabularnewline
4 8-oxo-G & 0.169 & 1.31 & 0.47\tabularnewline
\bottomrule
\end{longtable}
