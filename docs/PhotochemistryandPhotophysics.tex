...
\caption{Molecules have a number of different energy levels over which the internal energy of a molecule is distributed. Vibrational energy levels are essentially a continuum, however rotational vibrational and electronic levels all have measurable transitions.}\label{fig:energylevels}
\end{figure}
...
\hypertarget{sec:beforeabs}{%
\section{Before Completing this Section}\label{sec:beforeabs}}
...
\hypertarget{sec:beforequench}{%
\section{Before Completing this Section}\label{sec:beforequench}}
...
\hypertarget{sec:beforeex}{%
\section{Before Completing this Section}\label{sec:beforeex}}
...
\hypertarget{sec:saqex}{%
\section{Self Assessment Questions}\label{sec:saqex}}
...
\hypertarget{chphotochemistry}{%
\chapter{Photochemistry}\label{chphotochemistry}}
...
\hypertarget{sec:beforephoto}{%
\section{Before Completing this Section}\label{sec:beforephoto}}
