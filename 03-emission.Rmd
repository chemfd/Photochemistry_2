...
```{r echo=FALSE, Jablonski, out.width='70%', fig.show='hold', fig.align='center', fig.cap='Jablonski diagram showing: A, the absorption of a photon, and the photophysical deactivation pathways, IC, internal conversion, ISC, intersystem crossing, F, fluorescence and P, phosphorescence.'}
